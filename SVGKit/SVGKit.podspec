Pod::Spec.new do |s|
  ...
  s.source_files = 'SVGKit/*.{h,m}', 'SVGKit/**/*.{h,m}'
  s.exclude_files = 'SVGKit/include/*.h'
  s.private_header_files = 'SVGKit/SVGKDefine_Private.h'
  s.ios.private_header_files = 'SVGKit/AppKit additions/SVGKImageRep.h', 'SVGKit/Exporters/SVGKExporterNSImage.h'
  s.tvos.private_header_files = 'SVGKit/AppKit additions/SVGKImageRep.h', 'SVGKit/Exporters/SVGKExporterNSImage.h'
  s.osx.private_header_files = 'SVGKit/Exporters/SVGKExporterUIImage.h'
  s.libraries = 'xml2'
